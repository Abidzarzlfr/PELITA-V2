<nav class="navbar navbar-expand-lg bg-navbar py-3 sticky-top">
    <div class="container-fluid px-5">
        ...
        <a class="navbar-brand" href="/dokter"><img src="{{ asset('Main/assets/navbar/Logo-secondary.svg') }}" alt="" /></a>
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"></span>
        </button>
        @endif
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 gap-3">
                ...
                <!-- Profile Name -->
                <div class="nav-item">
                    <a href="/profile" class="btn btn-outline-secondary border-secondary">{{ Auth::user()->name }}</a>
                </div>
                <!-- Profile Photo -->
                <li class="nav-item">
                    <a href="/profile">
                ...
                <li class="nav-item">
                    <form action="" style="width: 40px; height: 40px;">
                        <button type="button" class="btn btn-secondary rounded-circle text-white w-100 h-100" data-bs-toggle="modal" data-bs-target="#confirmationLogout"><i class="fa-solid fa-person-walking-dashed-line-arrow-right"></i></button>
                    </form>
                </li>
            </ul>
            @endif
