...
@section('forumKomunitas')
<div class="row my-5">
    <div class="card text-center">
        <div class="card-header bg-primary-subtle fw-bold">Add Forum Komunitas</div>
        <div class="card-body">
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="input-group mb-3 mt-3">
                    <span for="name" class="input-group-text" id="basic-addon1">Nama Forum</span>
