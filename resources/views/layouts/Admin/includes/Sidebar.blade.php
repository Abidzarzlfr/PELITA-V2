<div class="bg-primary-subtle border-end border-dark" id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush my-3">
        ...
        <a href="#" class="list-group-item list-group-item-action bg-primary-subtle border-bottom border-dark"><i class="fas fa-project-diagram me-2 text-dark"></i>Dokter Request</a>
