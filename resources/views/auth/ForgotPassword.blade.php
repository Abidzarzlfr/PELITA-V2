        ...
        <div class="card shadow position-absolute top-50 start-50 translate-middle bg-white" style="width: 450px">
            <div class="card-body">
                <div class="header-register text-center">
                    ...
                    <p>
                        Silakan isi email anda dan masukkan kata sandi baru untuk mereset kata sandi anda
                    </p>
                    @if($errors->any())
                ...
                <form action="{{ route('useForgotPassword') }}" method="post">
                    @csrf
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="password" name="password" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" placeholder="kata sandi baru" id="passwordInput"/>
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1"><i class="fa-solid fa-key"></i></span>
                        <input type="password" name="password_confirmation" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" placeholder="konfirmasi kata sandi baru" id="confirmPasswordInput"/>
                    ...
                    <div class="masuk d-flex justify-content-center mt-2">
                        <p>
                            Tidak lupa password? <span><a href="/login">Masuk</a></span>
                        </p>
                    </div>
                </form>
            </div>
